...
@shipengine/integration-platform-cli/0.0.17 linux-x64 node-v12.18.1
...
_See code: [src/commands/info.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/info.ts)_
...
_See code: [src/commands/login.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/login.ts)_
...
_See code: [src/commands/logout.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/logout.ts)_
...
_See code: [src/commands/new.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/new.ts)_
...
_See code: [src/commands/publish.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/publish.ts)_
...
_See code: [src/commands/test.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/test.ts)_
...
_See code: [src/commands/whoami.ts](https://github.com/ShipEngine/shipengine-integration-platform-cli/blob/v0.0.17/src/commands/whoami.ts)_
<!-- commandsstop -->
