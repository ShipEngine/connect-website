...
module.exports = {
  dataSchema: {
    title: "FreightCo Login",
    description: "Connect your FreightCo account",
    type: "object",
    required: [
      "account_id",
      "account_email",
  ...
  localization: {
    es: {
      dataSchema: {
        title: "FreightCo Iniciar sesión",
        description: "Conecte su cuenta de FreightCo",
        properties: {
          account_id: {
    ...
    fr: {
      dataSchema: {
        title: "Connexion FreightCo",
        description: "Connectez votre compte FreightCo",
        properties: {
          account_id: {
