...
const { GetSalesOrdersByDatePaging } = require("../../../../../lib/core/test-app/tests/get-sales-orders-by-date-paging");
...
describe("The getSalesOrdersByDate test suite", () => {
  it("should generate a test", () => {
    ...
    const testSuite = new GetSalesOrdersByDatePaging(args);
