...
const { SchedulePickupSameDay } = require("../../../../../lib/core/test-app/tests/schedule-pickup-same-day");
...
describe("The schedule same day pickup test suite", () => {
  ...
  describe("when there is no address available for the delivery service", () => {
    it("should not generate tests", () => {
      ...
      const testSuite = new SchedulePickupSameDay(args);
  ...
  describe("when there is a delivery service with an available address", () => {
    ...
    beforeEach(() => {
      ...
      testSuite = new SchedulePickupSameDay(args);
    });
