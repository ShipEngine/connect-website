...
const { TrackShipment } = require("../../../../../lib/core/test-app/tests/track-shipment");
const { CarrierApp } = require("@shipengine/connect-sdk/lib/internal/carriers/carrier-app");
const pojo = require("../../../../utils/pojo");
const { expect } = require("chai");
const sinon = require("sinon");

describe("The track shipment test suite", () => {
  ...
  describe("when there is no delivery service", () => {
    ...
    it("should not generate tests", () => {
      ...
      const testSuite = new TrackShipment(args);
  ...
  describe("when there is a delivery service with an available address that supports tracking", () => {
    ...
    beforeEach(() => {
      ...
      testSuite = new TrackShipment(args);
    });
