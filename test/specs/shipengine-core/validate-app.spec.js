...
describe("validateApp() with a valid app", function () {
...
describe("validateApp() when there is not a manifest file", function () {
...
describe("validateApp() when the SDK is not a dependency", function () {
  it("returns errors", async function () {
    try {
...
describe("validateApp() when the apps structure is invalid", function () {
  it("returns errors", async function () {
    try {
