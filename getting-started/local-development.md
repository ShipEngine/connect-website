...
## Unit Tests
Another great way to test locally is to write unit tests for your code. We are
big fans of the [Jest](https://jestjs.io/) testing framework for executing the
methods without needing to stand up the server.
