...
<Reference>
  ...
  <Field name="identifiers[].type" type="string" nullable={false}>
    <Description>
      The tracking identifier type, either `tracking_number` or `carrier_transaction_id`.
    </Description>
  </Field>

 <Field name="identifiers[].value" type="string" nullable={false}>
    <Description>
