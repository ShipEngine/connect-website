...
<Reference>
  ...
  <Field name="location" nullable={true}>
    <Type>
      [pickup location object](./../address.mdx#pickut-location-object)
    </Type>
    <Description>
      Where it's being picked up. 
      Contact information for the pickup, like an on-duty manager that would be able to oversee the pickup at the location.
    </Description>
  </Field>
 ...
 <Field name="requested_pickup_window" nullable={false}>
    <Type>
      [pickup window object](./../pickup-window.mdx)
    </Type>
    <Description>
...
<Reference>
  ...
  <Field name="confirmation" type="object" required={false}>
    <Description>
      The confirmation code associated with the successful creation of a pickup.
    </Description>
  </Field>

  <Field name="confirmation.confirmation_id" type="string" required={false}>
    <Description>
      The primary confirmation ID for this request.
    </Description>
  </Field>

  <Field name="confirmation.alternate_identifiers" required={false}>
    <Type>
  ...
  <Field name="confirmation.shipment_identifiers" type="object[]" required={false}>
    <Description>
      List of the shipments added for this pickup.
    </Description>
  </Field>

  <Field name="confirmation.shipment_identifiers[].tracking_number" type="string" required={false}>
    <Description>
      The tracking number associated with the shipment.
    </Description>
  </Field>

  <Field name="confirmation.shipment_identifiers[].alternate_identifiers" required={false}>
    <Type>
      [identifier object[]](./../identifier.mdx)
    </Type>
    <Description>
