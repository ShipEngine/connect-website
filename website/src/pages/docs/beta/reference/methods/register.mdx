...
The `Register` method returns the result of the carrier's authentication process.
 This information will be included in the `metadata` of every subsequent request to yoru application.

<Reference>

  <Field name="credentials" type="object" nullable={false}>
    <Description>
      An object containing basic authentication information for the integration.
    </Description>
  </Field>

  <Field name="credentials.username" type="object" nullable={false}>
    <Description>
      The user's username
    </Description>
  </Field>

  <Field name="credentials.password" type="object" nullable={false}>
    <Description>
      The user's password
    </Description>
  </Field>

  <Field name="metadata" type="object" nullable={false} required={true}>
    <Description>
