...
### Example
This is an example of a `connect.config.js` file that provides multiple parameters to the [`createShipment_domestic` test](./../carrier-app/tests/create-shipment/create-shipment-domestic.mdx).
