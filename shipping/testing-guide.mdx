---
title: Testing Guide
description: This guide describes how to test a Carrier Connect app within ShipStation.
---

# Testing Guide


The purpose of a shipping integration is to integrate your carrier with our many e-commerce
...
[ShipStation](http://www.shipstation.com). Your shipping integration running in the platform makes it possible for ShipStation to
...
When you publish your app, a URL and set of credentials will be displayed on the console
