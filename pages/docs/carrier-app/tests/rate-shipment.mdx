...
------------------------------
Here's an example of using the `connect.config.js` file to customize the `rateShipment` test. This example provides values for all parameters and uses the global `connectArgs` parameter for authentication.
