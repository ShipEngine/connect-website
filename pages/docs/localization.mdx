...
your application for various markets. In anticipation of an upcoming localization feature, the structure of a [ShipEngine Connect](./index.mdx) application
...
For the [Carrier Application Definition](reference/carrier.mdx), you may provide localization information for the `name`, `description`, and `websiteURL` properties.
...
<Pager prev="./error-handling.mdx" prevTitle="Error Handling" next="./sandbox.mdx" nextTitle="Sandbox Environments" />
