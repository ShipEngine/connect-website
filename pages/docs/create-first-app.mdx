...
> **Info**
> Install [ShipEngine Connect CLI](./cli.mdx) before proceeding with this guide.
...
1. Run the following command: [`connect init`](./cli.mdx#initialize-a-new-app)  </br>
...
### Test
As you're building your app, you'll probably want to run it periodically so you can test and debug your code. Luckily, [ShipEngine Connect CLI](cli.mdx) includes commands to help with this, such as `connect start` and `connect test`. You can also write your own unit tests to exercise your code. See our [testing page](testing/index.mdx) for more information.
