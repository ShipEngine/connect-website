...
param:
  fields:
     ...
     - name: deliveryConfirmation
       ...
       required: true
       description: The types of [delivery confirmations](./delivery-confirmation.mdx) offered for this delivery service. This property may define
         the delivery confirmations directly inline, following the [delivery confirmation](./delivery-confirmation.mdx) format.
