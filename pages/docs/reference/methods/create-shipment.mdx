...
param:
  ...
  fields:
    - name: deliveryService
      ...
      description: An object that identifies a [delivery service](./../delivery-service.mdx) that is offered by a carrier.

    - name: deliveryConfirmation
      type: |
       [DeliveryConfirmation](./../delivery-confirmation.mdx)
      description: The requested [delivery confirmation](./../delivery-confirmation.mdx) for this shipment.
