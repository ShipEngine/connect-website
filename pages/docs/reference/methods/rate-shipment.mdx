...
```typescript
import { Transaction, RateCriteria, Rate } from "  @shipengine/connect-sdk";
...
<Reference>
  ...
  <Field name="fulfillmentService" nullable={true}>
    <Type>
      [FulfillmentService](./../fulfillment-service.mdx)
    </Type>
    <Description>
  ...
  <Field name="deliveryConfirmation" nullable={true}>
    <Type>
      [DeliveryConfirmation](./../delivery-confirmation.mdx)
    </Type>
    <Description>
  ...
  <Field name="deliveryDateTime" nullable={false}>
    <Type>
      [DateTime](./../date-time.mdx)
    </Type>
    <Description>
  ...
  <Field name="packages[].packaging.identifiers" type="object" nullable={false}>
    <Description>
  ...
  <Field name="packages[].weight" type="object" nullable={false}>
    <Description>
...
<Reference>
  ...
  <Field name="deliveryService" required={true}>
    <Type>
      [DeliveryService](./../delivery-confirmation-object.mdx#delivery-confirmation-return-value) | string
    </Type>
    <Description>
  ...
  <Field name="deliveryService.identifiers" type="object" required={false}>
    <Description>
  ...
  <Field name="deliveryConfirmation" required={true}>
    <Type>
      [DeliveryConfirmation](./../delivery-confirmation-object.mdx#delivery-confirmation-return-value) | string
    </Type>
    <Description>
      The [delivery confirmation](./../delivery-confirmation.mdx) included in this rate. This property accepts an object or a string representing the `id`, `code`, or `type`. If an object is provided, it will have the following properties.
    </Description>
  </Field>
  ...
  <Field name="deliveryConfirmation.identifiers" type="object" required={false}>
    <Description>
  ...
  <Field name="notes[].text" type="string" required={false}>
    <Description>
  ...
  <Field name="packages[].packaging" required={true}>
    ...
    <Description>
      The packaging this rate is for. This property accepts an object or a string representing the `code`. If an object is provided, it will have the following properties.
    </Description>
  </Field>
