...
param:
  ...
  fields:
    - name: shipFrom
      ...
      description: The address of the location that is performing end-of-day manifesting. This field is required if the carrier's `manifestLocations` setting is `single_location` in the [Carrier Definition](./../carrier.mdx) file.
