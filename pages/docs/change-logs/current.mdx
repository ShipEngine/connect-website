...
* Updated [CLI](./../cli.mdx) namespace. You should uninstall the old one before the latest version.
* Removed [NotesType](./../reference/common-types.mdx#notes-types) not supported by ShipStation.
* Removed `POJO`
...
* [CLI](./../cli.mdx) commands are no longer prefaced with `apps:`. The documentation has been updated.
* The `shipengine test` command has changed. We are in the process of updating the documentation for this.


## Carrier App
These changes affect the [Carrier App](./../carrier-app/index.mdx).

### [Carrier App Definition](./../reference/carrier.mdx)
* Added an `icon` property similar to the logo property.
* Added a `manifestType` property.
* Added a `trackingURLTemplate` property

### [createShipment()](./../reference/methods/create-shipment.mdx) Method
...
###  [rateShipment()](./../reference/methods/rate-shipment.mdx) Method
...
### [trackShipment()](./../reference/methods/track-shipment.mdx)
...
### [schedulePickup()](./../reference/methods/schedule-pickup.mdx)
...
### [cancelPickup()](./../reference/methods/cancel-pickups.mdx)
...
### Definition Changes
[Delivery Service](./../reference/delivery-service.mdx)
    *  Added `supportsReturns` property.
    *  Added  `manifestType` property.
    *  Added `code` property.

[Pickup Service](./../reference/pickup-service.mdx)
  * Added `code` property.

[Packaging](./../reference/packaging.mdx)
  * Added `code` property.

[Delivery Confirmation](./../reference/delivery-confirmation.mdx)
  * Added `code` property.

## Order  App
These changes affect the [Order App](./../order-app/index.mdx).

### Overall Changes
* Removed `deliveryDateTime` from [Shipping Preferences](./../reference/shipping-preferences.mdx)

### [Order App Definition](./../reference/order.mdx)
* Added an icon property similar to the logo property.
* Added a `sendEmail` property
* Added a `configureTimeZone` property

### [getSalesOrdersByDate()](./../reference/methods/get-sales-orders-by-date.mdx)
...
### [shipmentCreated()](./../reference/methods/shipment-created.mdx)
...
### [shipmentCancelled()](./../reference/methods/shipment-cancelled.mdx)
#### Parameter: `SalesOrderShipment`
#### Removed properties:
    * `deliveryDateTime`
    * `minimumDeliveryDays`
