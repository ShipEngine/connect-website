...
------------------------
Shipengine Connect applications are NPM packages that export an object matching a certain structure. Please see [our application structure guide](./structure.mdx) as well as our [sample apps](https://github.com/ShipEngine/connect-samples) for more information.
