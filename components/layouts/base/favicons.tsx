...
export function Favicons() {
  return <>
    ...
    */}
    <link rel="apple-touch-icon" sizes="180x180" href={`${siteURL.pathname}img/favicons/apple-touch-icon-180x180.png`}/>
    <link rel="apple-touch-icon" sizes="152x152" href={`${siteURL.pathname}img/favicons/apple-touch-icon-152x152.png`}/>
    <link rel="apple-touch-icon" sizes="120x120" href={`${siteURL.pathname}img/favicons/apple-touch-icon-120x120.png`}/>
