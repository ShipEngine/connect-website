...
export const menu: MenuContents = [
      ...
      },
      {
        ...
        menuItems: [
          ...
          { title: 'Form Definitions', href: '/docs/reference/forms' },
          {
            ...
            href: '/docs/reference/transaction',
          },
          {
            title: 'Order App Transaction',
            href: '/docs/reference/order-transaction',
          },
    ...
    subGroups: [
      {
        ...
        menuItems: [
          { title: 'Overview', href: '/docs/carrier-app' },
          {
            ...
            href: '/docs/carrier-app/map-services',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        menuItems: [
          { title: 'connect', href: '/docs/reference/methods/connect' },
          {
            ...
            href: '/docs/reference/methods/create-shipment',
          },
          {
            title: 'cancelShipments',
            href: '/docs/reference/methods/cancel-shipments',
          },
          {
            title: 'trackShipment',
            href: '/docs/reference/methods/track-shipment',
          },
          {
            title: 'rateShipment',
            href: '/docs/reference/methods/rate-shipment',
          },
          {
          ...
          {
            title: 'cancelPickups',
            href: '/docs/reference/methods/cancel-pickups',
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        menuItems: [
          { title: 'Order App', href: '/docs/reference/order' },
          {
            ...
            href: '/docs/reference/forms#order-apps',
          },
        ],
      },
      {
        ...
        menuItems: [
          {
            ...
            href: '/docs/reference/methods/get-sales-orders-by-date',
          },
          {
            title: 'shipmentCreated',
            href: '/docs/reference/methods/shipment-created',
          },
          {
  ...
  },
  {
    ...
    subGroups: [
      {
        title: 'Overview',
        menuItems: [{ title: 'Connect Apps 2.0', href: '/docs/beta' }],
      },
      {
        title: 'App Structure',
        menuItems: [
      ...
      },
      {
        ...
        menuItems: [
          ...
          {
            title: 'Create Label',
            href: '/docs/beta/reference/methods/create-label',
          },
          {
            title: 'Void Labels',
            href: '/docs/beta/reference/methods/void-labels',
          },
          {
            title: 'Create Manifest',
            href: '/docs/beta/reference/methods/create-manifest',
          },
          {
            title: 'Schedule Pickup',
            href: '/docs/beta/reference/methods/schedule-pickup',
          },
          {
            title: 'Cancel Pickup',
            href: '/docs/beta/reference/methods/cancel-pickup',
          },
          {
            title: 'Get Rates',
            href: '/docs/beta/reference/methods/get-rates',
          },
      ...
      },
      {
        ...
        menuItems: [
          ...
          {
            title: 'Country Codes',
            href: '/docs/beta/reference/country-codes',
          },
          { title: 'Common types', href: '/docs/beta/reference/common-types' },
          {
            title: 'Billing Line Item',
            href: '/docs/beta/reference/billing-line-item',
          },
          {
            title: 'Fulfillment Plan Details',
            href: '/docs/beta/reference/fulfillment-plan-details',
          },
          { title: 'Track Event', href: '/docs/beta/reference/track-event' },
          {
            title: 'Shipped Shipment',
            href: '/docs/beta/reference/shipped-shipment',
          },
          {
            title: 'Shipped Package',
            href: '/docs/beta/reference/shipped-package',
          },
          {
            title: 'Pickup Window',
            href: '/docs/beta/reference/pickup-window',
          },
          {
            title: 'Pickup Confirmation',
            href: '/docs/beta/reference/pickup-confirmation',
          },
        ],
      },
    ],
    ...
    subGroups: [
      ...
      },
      {
        ...
        menuItems: [
          {
            title: 'Order App',
            href: '/docs/beta/app-definition/order-source',
          },
        ],
      },
    ],
