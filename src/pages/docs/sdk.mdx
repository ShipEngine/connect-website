...
description: The ShipEngine Connect SDK has everything you need to quickly and efficiently build an integration application
---

ShipEngine Connect SDK
========================
The [ShipEngine Connect SDK](https://www.npmjs.com/package/@shipengine/connect-sdk) has everything you need to quickly and efficiently build an integration application.
