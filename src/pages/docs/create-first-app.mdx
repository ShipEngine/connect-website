...
1. Use the arrow keys to select whether you want to create a [Carrier App](./v1/carrier-app/index.mdx) or [Order App](./v1/order-app/index.mdx), then press `Enter`.
...
specifies the path to a file that exports the method, the structure is up to you. This is an example of the method stub that is generated for the `createShipment` method of a [Carrier Application](./v1/carrier-app/index.mdx).
...
in a Carrier Application, you may provide one or more definitions for the following: [delivery service](./v1/reference/delivery-service.mdx), [delivery confirmation](./v1/reference/delivery-confirmation.mdx),
and [packaging](./v1/reference/packaging.mdx).
