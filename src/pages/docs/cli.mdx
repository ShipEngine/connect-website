...
##### `--raw`
Show the raw, unformatted logs that are being returned from the ShipEngine platform.

##### `--lines`
Show the tail of the ShipEngine platform logs up to 1500 lines. The default is 1500.
