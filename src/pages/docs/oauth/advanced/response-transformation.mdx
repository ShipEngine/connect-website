...
from the two exchanges can be mapped into the the platform canonical model, the
[`IntegrationTokenResponse`](../the platform/Server/Data/IntegrationTokenResponse.cs).
