...
To accommodate for this, Auth Bridge allows a response transformer to specify
...
[``](https://github.com/shipstation/Auth Bridge/blob/main/Auth Bridge/Server/Controllers/Contracts/TokenResponse.cs#L11)
object).
...
/* results in the following Auth Bridge TokenResponse */
{
    "access_token": "foo",
    "token_type": "bearer",
    "refresh_token": "bar",
    ...
    "Auth Bridge_created_at": "2021-07-12T18:50:27.7451244Z",
    "Auth Bridge_application_id": "sample-application",
