...
- [Response Transformation](./advanced/response-transformation.mdx) _(specify how responses from the two exchanges can be mapped into the the platform canonical model)_
- [Connection Context](./advanced/connection-context.mdx) _(allows a response transformer to specify a collection of properties in connection_context)_
- [Templating](./templating/index.mdx) _(substituting values in your configuration \{installation:client_id\}, etc...)_

<Pager prev="./index.mdx" prevTitle="OAuth Configuration" />
