...
- `{system:authorize_callback_url}` will be updated using the [system resolver](../templating/system.mdx) with the url in ShipEngine Connect that will handle the callback.
