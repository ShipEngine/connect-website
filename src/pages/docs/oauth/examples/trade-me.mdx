...
```
It also needed to take advantage of [response transformation](../advanced/response-transformation.mdx) to map the response payload from the `RequestToken` endpoint.
### Example Response Payload:
``` JSON
{
  "access_token": "ACCT-fmY4FS",
  "expires_in": "3600",
  "refresh_token": "REFT-z3p5xY",
  "id_token": "IDT-W51yEr",
  "state": "some-state",
