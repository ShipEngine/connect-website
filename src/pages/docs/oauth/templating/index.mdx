...
| Expression  | Resolver |
| ----------- | ----------- |
| `{auth_state:` | [Auth State](./auth-state.mdx) |
| `{base64:` | [Base64](./base64.mdx) |
| `{callback:` | [Callback](./callback.mdx) |
| `{integration:` | [Integration](./integration.mdx) |
| `{installation:` | [Installation](./installation.mdx) |
| `{result_token_response:` | [Result Token Response](./result-token-response.mdx) |
| `{system:` | [System](./system.mdx) |
