...
ShipEngine Connect applications are designed to handle [Errors](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) in the the same way as any other [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript) application.
...
ShipEngine Connect exports several helper classes for use in common error scenarios. Each class wraps a specific
