...
- [connection form](./v1/reference/forms.mdx#connection-form-examples)
- [settings form](./v1/reference/forms.mdx)
- [delivery service](./v1/reference/delivery-service.mdx)
- [packaging](./v1/reference/packaging.mdx)
- [delivery confirmation](./v1/reference/delivery-confirmation.mdx)
...
Only one [delivery confirmation](./v1/reference/delivery-confirmation.mdx) definition file should be created for
