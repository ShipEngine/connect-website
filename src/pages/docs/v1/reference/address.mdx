...
<Field name="addressLines" type="string[]" nullable={true} required={false}>
  <Description>
    Rather than providing two or three distinct address fields, simply provide all lines of the address in a string
    array. Each string in the array must be between `0` and `100` characters and must not include newline characters.
  </Description>
</Field>
...
<Field name="cityLocality" type="string" nullable={true} required={false}>
  <Description>The city or locality for this address. This string must not include newline characters.</Description>
</Field>

{' '}

<Field name="stateProvince" type="string" nullable={true} required={false}>
  <Description>The state or province for this address. This string must not include newline characters.</Description>
</Field>
...
<Field name="name.title" type="string" nullable={false} required={false}>
  <Description>The title of the contact (eg "Mr", "Mrs", "Dr"). This must not include newline characters.</Description>
</Field>

{' '}

<Field name="name.given" type="string" nullable={false} required={true}>
  <Description>The first name of the signer. This must not include newline characters.</Description>
</Field>

{' '}

<Field name="name.middle" type="string" nullable={false} required={false}>
  <Description>The middle name of the signer. This must not include newline characters.</Description>
</Field>

{' '}

<Field name="name.family" type="string" nullable={false} required={false}>
  <Description>The last name or family name of the signer. This must not include newline characters.</Description>
</Field>

{' '}

<Field name="name.suffix" type="string" nullable={false} required={false}>
  <Description>The suffix of the signer (eg "Sr", "Jr", "IV"). This must not include newline characters.</Description>
</Field>
...
<Field name="relayId" type="string" nullable={false} required={true}>
  <Description>The Relay Id of the desired Pickup Location.</Description>
</Field>

{' '}

<Field name="carrierId" type="string" nullable={false} required={true}>
  <Description>The Carrier Id of the desired Pickup Location.</Description>
</Field>
...
<Field name="company" type="string" nullable={false} required={true}>
  <Description>
    The company name for the address, if provided. This string must not include newline characters and must not include
    newline characters.
  </Description>
</Field>
...
<Field name="isResidential" type="boolean" nullable={true} required={false}>
  <Description>A boolean value indicating whether or not the address is residential.</Description>
</Field>
...
<Field name="phoneNumber" type="string" nullable={false} required={false}>
  <Description>The phone number of the contact. This string must not include newline characters.</Description>
</Field>
...
<Field name="pickupLocation" type="object" nullable={true} required={false}>
  <Description>The Pickup Location asscoated with, or to use instead of, this address.</Description>
</Field>
