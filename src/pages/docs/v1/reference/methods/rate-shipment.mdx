...
export default async function rateShipment(transaction: Transaction, criteria: RateCriteria): Promise<Rate[]> {
  // Your code here
}
```
...
<Field name="shipFrom" nullable={false}>
  ...
  <Description>The sender's contact info and address.</Description>
</Field>
...
<Field name="shipTo" nullable={false}>
  <Type>[address + contact info object](./../address.mdx#address-contact-info-properties)</Type>
  <Description>The recipient's contact info and address.</Description>
</Field>
...
<Field name="packages" type="object[]" nullable={false}>
  <Description>The list of packages in the shipment.</Description>
</Field>
...
<Field name="packages[].packaging.id" nullable={false}>
  ...
  <Description>
    A UUID that uniquely identifies the object. This is the UUID you used in the [Packaging
...
<Field name="packages[].packaging.name" type="string" nullable={false}>
  <Description>
    The user-friendly name for this packaging (e.g. "Flat-Rate Box", "Large Padded Envelope"). This string will not
...
<Field name="packages[].packaging.requiresWeight" type="boolean" nullable={false}>
  <Description>Indicates whether the weight must be specified when using this packaging.</Description>
</Field>

{' '}

<Field name="packages[].packaging.requiresDimensions" type="boolean" nullable={false}>
  <Description>Indicates whether the dimensions must be specified when using this packaging.</Description>
</Field>
...
<Field name="packages[].dimensions.unit" type="string" nullable={false}>
  <Description>
    The unit of measurement for the dimensions. Valid values include the following: * `in` - inches * `cm` - centimeters
  </Description>
</Field>
...
<Field name="packages[].weight.unit" type="string" nullable={false}>
  <Description>
    The unit of measure for this weight. Valid values include the following: * `g` - grams * `oz` - ounces * `kg` -
    kilograms * `lb` - pounds
  </Description>
</Field>
...
<Field name="packages[].isNonMachineable" type="boolean" nullable={false}>
  <Description>
    Indicates whether the package cannot be processed automatically due to size, shape, weight, etc. and requires manual
    handling.
  </Description>
</Field>
...
<Field name="deliveryService" nullable={true}>
  ...
  <Description>
    An object that indicates the [delivery service](../delivery-service.mdx) to get rates for. If neither
    `deliveryService` nor `fulfillmentService` are specified, then rate quotes should be returned for all applicable
    services.
  </Description>
</Field>
...
<Field name="fulfillmentService" nullable={true}>
  <Type>[fulfillment service string](./../fulfillment-service.mdx)</Type>
  <Description>
    The [fulfillment service](./../fulfillment-service.mdx) that may be used to fulfill the shipment. If neither
    `deliveryService` nor `fulfillmentService` are specified, then rate quotes should be returned for all applicable
    services.
  </Description>
</Field>
...
<Field name="deliveryConfirmation" nullable={true}>
  <Type>[delivery confirmation object](./../delivery-confirmation.mdx)</Type>
  <Description>
...
<Field name="deliveryDateTime" nullable={true}>
  ...
  <Description>The latest date and time that the shipment can be delivered.</Description>
</Field>
...
<Field name="totalInsuredValue.currency" type="string" nullable={false}>
  <Description>The currency for this value.</Description>
</Field>

{' '}

<Field name="totalInsuredValue.value" type="number" nullable={false}>
  <Description>The amount of this value.</Description>
</Field>
...
<Field name="deliveryService.id" required={true}>
  <Type>[UUID](https://www.npmjs.com/package/uuid)</Type>
  <Description>
    A UUID that uniquely identifies the object. This is the UUID you used in the [Delivery Service
    Definition](./../delivery-service.mdx) file for this delivery service.
  </Description>
</Field>
...
<Field name="deliveryService.identifiers" required={false}>
  <Description>Your own identifiers for this delivery service.</Description>
  <Type>[identifiers object](./../identifiers-object.mdx)</Type>
</Field>
...
<Field name="charges" required={true}>
  ...
  <Description>
    ...
    single charge of type "shipping". If the carrier does not provide any charges values at all, return a $0 value
    charge.
  </Description>
</Field>
...
<Field name="isNegotiatedRate" type="boolean" required={false}>
  <Description>Indicates whether this shipment used a pre-negotiated terms.</Description>
</Field>

{' '}

<Field name="isTrackable" type="boolean" required={false}>
  <Description>Indicates whether tracking numbers are provided.</Description>
</Field>
...
<Field name="deliveryConfirmation.id" required={true}>
  <Type>[UUID](https://www.npmjs.com/package/uuid)</Type>
  <Description>UUID that uniquely identifies the delivery confirmation. This ID should never change.</Description>
</Field>

{' '}

<Field name="deliveryConfirmation.identifiers" required={false}>
  <Description>Your own identifiers for this delivery confirmation.</Description>
  <Type>[identifiers object](./../identifiers-object.mdx)</Type>
</Field>
...
<Field name="packages" type="object[]" required={false}>
  <Description>An array of objects describing the list of packages in the shipment.</Description>
</Field>
