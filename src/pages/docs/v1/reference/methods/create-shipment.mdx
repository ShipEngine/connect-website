...
<Field name="shipFrom" nullable={false}>
  <Type>[address + contact info object](./../address.mdx#address-contact-info-properties)</Type>
  <Description>The address _from_ which the shipment is being shipped.</Description>
</Field>
...
<Field name="shipTo" nullable={false}>
  <Type>[address + contact info object](./../address.mdx#address-contact-info-properties)</Type>
  <Description>The address _to_ which the shipment is being shipped.</Description>
</Field>
...
<Field name="pickupLocation" nullable={true}>
  ...
  <Description>The location where the recipient can pick up the shipment.</Description>
</Field>
...
<Field name="returnTo" nullable={false}>
  <Type>[address + contact info object](./../address.mdx#address-contact-info-properties)</Type>
  <Description>
    The address to which to send the shipment in the case of a return. This may be different from the `shipFrom` address
    if the customer uses a centralized returns processing facility.
  </Description>
</Field>
...
<Field name="totalInsuredValue" type="object" nullable={false}>
  <Description>The total insured value of all packages in the shipment.</Description>
</Field>
...
<Field name="isNonMachineable" type="boolean" nullable={false}>
  <Description>
    Indicates whether the shipment cannot be processed automatically due to size, shape, weight, etc. and requires
    manual handling. This property is `true` if any package in the shipment is non-machinable.
  </Description>
</Field>
...
<Field name="returns" type="object" nullable={false}>
  <Description>An object that indicates whether or not this shipment is a return shipment.</Description>
</Field>

{' '}

<Field name="returns.isReturn" type="boolean" nullable={false}>
  <Description>Indicates whether or not this shipment is a return shipment.</Description>
</Field>
...
<Field name="returns.rmaNumber" type="string" nullable={false}>
  <Description>
    A [return merchandise authorization (RMA)](https://en.wikipedia.org/wiki/Return_merchandise_authorization) is an
    associated number assigned to process the return. This number is often printed on the label and used when the
    original shipper processes the inbound return. This string will not contain newline characters.
  </Description>
</Field>
...
<Field name="packages" nullable={false}>
  <Type>[new package object[]](./../new-package-object.mdx)</Type>
  <Description>The list of packages in this shipment.</Description>
</Field>
...
<Field name="deliveryConfirmation" nullable={true}>
  <Type>[delivery confirmation object](./../delivery-confirmation-object.mdx#delivery-confirmation-argument)</Type>
  <Description>The requested [delivery confirmation](./../delivery-confirmation.mdx) for this shipment.</Description>
</Field>

{' '}

<Field name="shippingOptions" nullable={true}>
  <Type>[shipping options](./../shipping-options.mdx)</Type>
  <Description>The shipping options that are required for this shipment.</Description>
</Field>
...
<Field name="label" type="object" required={true}>
  <Description>An object representing the shipping label details.</Description>
</Field>

{' '}

<Field name="label.name" type="string" required={false}>
  <Description>The user-friendly name of the label. This string must not contain newline characters.</Description>
</Field>
...
<Field name="label.size" type="string" required={true}>
  <Description>
    The size of the label. Valid values include the following: * `A4`- A4 sized paper ( 8.27 inches x 11.69 inches) *
    `letter` - Letter sized paper (8.5 inches by 11 inches) * `4x6` - Paper sized 4 inches by 6 inches * `4x8` - Paper
    sized 4 inches by 8 inches
  </Description>
</Field>
...
<Field name="label.format" type="string" required={true}>
  <Description>
    The file format of the label. Valid values include the following: * `pdf` - Portable Document Format (PDF) * `zpl` -
    Zebra Printer Label (ZPL) * `png` - Portable Graphics Format (PNG)
  </Description>
</Field>
...
<Field name="label.data" required={true}>
  ...
  <Description>The label data, in the specified file format.</Description>
</Field>
...
<Field name="label.referenceFields" type="string[]" required={true}>
  <Description>
    The **actual** reference fields on the label, which may not match the originally-specified reference fields due to
    the carrier's restrictions on the number of fields or the length of each field. Each string in this array must not
...
<Field name="form.name" type="string" required={false}>
  <Description>
    The user-friendly name of the form (e.g. "Customs Form", "Scan Form"). This string must not contain newline
    characters.
  </Description>
</Field>
...
<Field name="form.type" type="string" required={true}>
  <Description>The type of form. This value should be `customs_form` or `scan_form`.</Description>
</Field>
...
<Field name="form.size" type="string" required={true}>
  <Description>
    The size of the form. Valid values include the following: * `A4`- A4 sized paper ( 8.27 inches x 11.69 inches) *
    `letter` - Letter sized paper (8.5 inches by 11 inches) * `4x6` - Paper sized 4 inches by 6 inches * `4x8` - Paper
    sized 4 inches by 8 inches
  </Description>
</Field>
...
<Field name="form.format" type="string" required={true}>
  <Description>
    The file format of the form. Valid values include the following: * `pdf` - Portable Document Format (PDF) * `zpl` -
    Zebra Printer Label (ZPL) * `png` - Portable Graphics Format (PNG)
  </Description>
</Field>
...
<Field name="form.data" required={true}>
  <Type>[Buffer object](https://nodejs.org/api/buffer.html)</Type>
  <Description>The form data, in the specified file format.</Description>
</Field>
...
<Field name="deliveryDateTime" required={false}>
  ...
  <Description>The estimated date and time the shipment will be delivered.</Description>
</Field>
...
<Field name="packages" type="object[]" required={false}>
  <Description>
    An array of objects containing confirmation details about each package in the shipment. This array will contain at
    least one item.
  </Description>
</Field>
