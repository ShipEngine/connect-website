...
export default async function shipmentCreated(transaction: Transaction, shipment: SalesOrderShipment): Promise<void> {
  // Your code here
}
```
...
<Field name="carrierServiceCode" nullable={true} type="string">
  <Description>
    If the shipment is being fulfilled using a well-known third-party carrier, such as UPS, FedEx, DHL, etc., then this
    field specifies the service code.
  </Description>
</Field>
