...
<Field name="importedDate" nullable={false}>
  ...
  <Description>The date that the order was imported.</Description>
</Field>
...
<Field name="succeeded" type="boolean" required={true}>
  <Description>Indicate whether the sales order's import was successfully processed.</Description>
</Field>
