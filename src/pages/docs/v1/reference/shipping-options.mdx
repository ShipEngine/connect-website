...
<Field name="dangerousGoodsCategory" type="string" required={false}>
  <Description>Indicates the category of dangerous goods(if any) that the shipment contents contain.</Description>
</Field>

{' '}

<Field name="billDutiesToSender" type="boolean" required={false}>
  <Description>Indicates if the carrier should bill duties to the sender.</Description>
</Field>
