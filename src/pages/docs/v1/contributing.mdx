...
1. To get started with Connect, follow the [online documentation to create a new app](./cli#initialize-a-new-app).

2. Once you have [installed the Connect npm package](./cli) => `npm i @shipengine/connect -g`, you will be able to generate a new templated base repository via the cli => `connect init`.
...
<Pager prev="./tools/index.mdx" prevTitle="Recommended Tools" next="./style.mdx" nextTitle="Style Guide" />
