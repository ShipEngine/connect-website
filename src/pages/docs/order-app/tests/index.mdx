...
| Test Name | Description
|-----------|------------------------------------------
|[`getSalesOrdersByDate`](./get-sales-orders-by-date/get-sales-orders-by-date.mdx) | Generates notification and transaction data and submits it to your `getSalesOrdersByDate` method.
