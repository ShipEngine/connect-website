...
You will likely need to provide a [session auth token](../../oauth/index.mdx) object to fulfill your app's authentication needs.
...
| Test Name | Description
|-----------|------------------------------------------
|[`getSalesOrdersByDate`](./get-sales-orders-by-date/get-sales-orders-by-date.mdx) | Retrieves sales orders for the provided date rate.
