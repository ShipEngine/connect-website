...
> **INFO:** These testes exercise your [`getSaleOrderByDate` method](./../v1/reference/methods/get-sales-orders-by-date.mdx).
If your app implements an [`acknowledgeOrders` method](./../v1/reference/methods/acknowledge-orders.mdx), it will be called
...
## Creating Labels
> **INFO:** These tests exercise your [`shipmentCreated` method](./../v1/reference/methods/shipment-created.mdx).
...
in your [`shipmentCreated method`](./../v1/reference/methods/shipment-created).
