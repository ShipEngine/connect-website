...
> **INFO:** These tests exercise your [`connect` method](./../v1/reference/methods/connect.mdx) and your
> [connection form](./../v1/reference/forms.mdx#connect-form).
...
correct. Click on the logo to access your app's [connection form](./../v1/reference/forms.mdx#connection-form).
...
> **INFO:**
> These tests exercise your [`rateShipment` method](./../v1/reference/methods/rate-shipment).
...
> **INFO:** These tests exercise your [`createShipment` method](./../v1/reference/methods/create-shipment.mdx).
...
> **INFO:** These tests execute your [`rateShipment` method](./../v1/reference/methods/rate-shipment.mdx).
...
> **INFO:** These tests exercise your [`rateShipment` method](./../v1/reference/methods/rate-shipment.mdx).
...
> **INFO:** These tests exercise your [`cancelShipments` method](./../v1/reference/methods/cancel-shipments.mdx).
...
> **INFO:** These tests exercise your [`trackShipment` method](./../v1/reference/methods/track-shipment.mdx).
...
This test validates the `trackingUrlTemplate` property in your [Carrier App definition](./../v1/reference/carrier.mdx).
...
> **INFO:** These tests exercise your [`schedulePickup` method](./../v1/reference/methods/schedule-pickup.mdx).
...
> **INFO:** These tests exercise your [`cancelPickups` method](./../v1/reference/methods/cancel-pickups.mdx).
...
> **INFO:** These tests exercise your [`createManifest` method](./../v1/reference/methods/create-manifest.mdx).
