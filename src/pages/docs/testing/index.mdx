...
Local Testing
-------------------------------------------------------
[The `connect start` command](./../cli.mdx#run-your-app-locally) provides tooling for testing your app locally during development.

> **INFO:**
> Checkout out or [local testing guide](./../local-tooling/index.mdx) to learn more.
