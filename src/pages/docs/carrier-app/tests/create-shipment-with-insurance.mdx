---
title: Automated Tests | createShipment_with_insurance
...
<Reference>
  ...
  <Field name="debug" type="boolean">
    <Description>
      Indicates whether or not to run the test in `debug` mode, which provides more insight into test failures.
    </Description>
    <DefaultValue>
      `false`
    </DefaultValue>
  ...
  <Field name="skip" type="boolean">
    <Description>
      Indicates whether or not to skip this test.
    </Description>
    <DefaultValue>
      `false`
    </DefaultValue>
  ...
  <Field name="packageInsuredValue" type="object">
    <Description>
    ...
    <DefaultValue>
        ...
        If a `packageInsuredValue` parameter is specified, it must contain values for all properties.
    </DefaultValue>
  </Field>

  <Field name="packageInsuredValue.value" type="number">
    <Description>
  ...
  <Field name="packageInsuredValue.currency" type="string">
    <Description>
...
------------------------------
Here's an example of using the [`connect.config.js` file](./../../testing/config.mdx) to customize the `createShipment_with_insurance` test.
