---
title: Acceptance Tests | rateShipment_return
...
### `rateShipment_return`
This test exercises your app's ability to successfully return rate quotes for a single [delivery service](./../../../reference/delivery-service.mdx) that supports returns.
...
<Reference>
  ...
  <Field name="deliveryServiceName" type="string">
    ...
    <DefaultValue>
      The name of the first delivery service defined for your app that supports returns. 
      If your app does not have any deliveryServices that supports returns, this test will be skipped.
    </DefaultValue>
  </Field>
...
------------------------------
Here's an example of using the [`connect.config.js` file](./../../../testing/config.mdx) to customize the `rateShipment_return` test.
