---
title: Automated Tests | createShipment_multipackage
description: This test is part of the ShipEngine Connect carrier app test suite. It tests your app's ability to create a shipment that has multiple packages.
---
...
<Reference>
  ...
  <Field name="packages[].packagingName" type="string" required={false}>
    <Description>
        The [delivery confirmation](../../reference/delivery-confirmation.mdx) to use for this package.
    </Description>
  </Field>

  <Field name="packages[].label" type="object" required={true}>
    <Description>
  ...
  <Field name="packages[].label.size" type="string" required={true}>
    <Description>
  ...
  <Field name="packages[].label.format" type="string" required={true}>
    <Description>
  ...
  <Field name="packages[].label.referenceFields" type="string[]" required={false}>
  ...
  <Field name="packages[].weight.unit" type="string" required={false}>
    <Description>
  ...
  <Field name="packages[].weight.value" type="number" required={false}>
    <Description>
  ...
  <Field name="packages[].deliveryConfirmationName" type="string" required={false}>
    <Description>
...
------------------------------
Here's an example of using the `connect.config.js` file to customize the `createShipment_multipackage` test. This example provides values for all parameters and uses the global `connectArgs` parameter for authentication.
