---
title: Acceptance Tests | cancelPickup_next_day
...
### `cancelPickup_next_day`

This test exercises your app's ability to successfully cancel a next day pickup. If your app does not have any [pickup services](../../../reference/pickup-service.mdx), then this test will be skipped by [the `connect test` command](../../../cli.mdx#test-your-app).
...
<Reference>
  ...
  <Field name="pickupServiceName" type="string">
   ...
   <Field name="deliveryServiceName" type="string">
      ...
      <DefaultValue>
        The name of the first delivery service defined for your app. If your app does not define any pickup services, this test will be skipped.
      </DefaultValue>
    </Field>
