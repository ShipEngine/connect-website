---
title: Acceptance Tests | createShipment_international
...
<Reference>
 ...
 <Field name="session" type="object">
  ...
  <Field name="shipFrom">
    ...
    <DefaultValue>
        A valid international address based on the `availableCountries` of the delivery service.
...
------------------------------
Here's an example of using the [`connect.config.js` file](./../../../testing/config.mdx) to customize the `createShipment_international` test.
