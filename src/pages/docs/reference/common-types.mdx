...
<Field name="delivery_confirmation">
  <Description>
    The charge is for a delivery confirmation, such as requiring an adult
    signature.
  </Description>
</Field>
...
<Field name="adjustment">
  <Description>
    The charge is for an adjustment. This can happen if the package dimensions
    or weight are different from what was used when the label was generated. It
    would be negative for a refund.
  </Description>
</Field>
...
<Field name="coupon">
  <Description>
    The charge is because a coupon was applied. This would be reflected by a
    negative value.
  </Description>
</Field>
...
<Field name="credit">
  <Description>
    The charge is because a credit was applied. This would be reflected by a
    negative value.
  </Description>
</Field>
...
<Field name="gift_certificate">
  <Description>
    The charge is because a gift certificate was applied. This would be
    reflected by a negative value.
  </Description>
</Field>
...
<Field name="promotion">
  <Description>
    The charge is because of a promotion. This would be reflected by a negative
    value.
  </Description>
</Field>
...
<Field name="uncategorized">
  <Description>
    The charge is for something that does not fit into any of the other
    categories.
  </Description>
</Field>
