...
<Reference>
  ...
  <Field name="providerId" required={false}>
    ...
    <Description>
      A UUID that is used to relate this app to an existing proudction application. Do not set this field unless instructed to by the shipengine connect team.
    </Description>
  </Field>
  ...
  <Field name="rateShipment" required={false}>
    <Type>
      method *or* string
    </Type>
    <Description>
      A method used to calculate shipping costs for a shipment, or multiple permutations of a shipment. You may define this method direcly inline inside of this file or you may specify the path to the file that exports your [`rateShipment`](./methods/rate-shipment.mdx) method.
    </Description>
  </Field>
