...
===============================================
A custom shipping object contains the shipping options that are specific to your carrier only. 
...
This table lists the properties of a `customShippingOptions` object and identifies those properties that are required. The `nullable`
