...
<Reference>
  ...
  <Field name="customShippingOptions" nullable={true}>
    <Type>
      [custom shipping options](./../custom-shipping-options.mdx)
    </Type>
    <Description>
      The custom shipping options that are required for this shipment.
    </Description>
  </Field>
