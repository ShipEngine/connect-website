...
<Reference>
  ...
  <Field name="salesOrder.id" nullable={false}>
    ...
    <Description>
      The marketplace's unique ID for the sales order. This string must be between `0` and `100` characters and must not contain newline characters.
    </Description>
  </Field>
  ...
  <Field name="contents[].salesOrderItem.id" type="string" nullable={false}>
    <Description>
      The marketplace's unique ID for the sales order item. This string must be between `0` and `100` characters and must not contain newline characters.
    </Description>
  </Field>
