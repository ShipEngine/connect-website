...
<Field name="packages[].packaging.id" nullable={false}>
  ...
  <Description>
    A UUID that uniquely identifies the object. This is the UUID you used in the
    [Packaging Definition](./../packaging.mdx) file for this packaging.
  </Description>
</Field>
...
<Field name="packages[].weight.unit" type="string" nullable={false}>
  <Description>
    ...
    `g` - grams * `oz` - ounces * `kg` - kilograms * `lb` - pounds
  </Description>
</Field>
...
<Field name="deliveryService" nullable={true}>
  ...
  <Description>
    An object that indicates the [delivery service](../delivery-service.mdx) to
    get rates for. If neither `deliveryService` nor `fulfillmentService` are
    specified, then rate quotes should be returned for all applicable services.
  </Description>
</Field>
...
<Field name="fulfillmentService" nullable={true}>
  ...
  <Description>
    The [fulfillment service](./../fulfillment-service.mdx) that may be used to
    fulfill the shipment. If neither `deliveryService` nor `fulfillmentService`
    are specified, then rate quotes should be returned for all applicable
    services.
  </Description>
</Field>
...
<Field name="deliveryConfirmation" nullable={true}>
  ...
  <Description>
    The type of package [delivery confirmation](./../delivery-confirmation.mdx)
...
<Field name="deliveryService.id" required={true}>
  ...
  <Description>
    A UUID that uniquely identifies the object. This is the UUID you used in the
    [Delivery Service Definition](./../delivery-service.mdx) file for this
    delivery service.
  </Description>
</Field>
...
<Field name="deliveryService.code" type="string" required={false}>
  <Description>
    Optional code used to map to what the carrier or marketplace uses to
    identify the delivery service.
  </Description>
</Field>
...
<Field name="charges" required={true}>
  ...
  <Description>
    ...
    a detailed breakdown, then just use a single charge of type "shipping". If
    the carrier does not provide any charges values at all, return a $0 value
    charge.
  </Description>
</Field>
...
<Field name="shipDateTime" required={false}>
  ...
  <Description>
    The date/time that the shipment is expected to ship. This is not guaranteed
    to be in the future.
  </Description>
</Field>
...
<Field name="deliveryConfirmation.id" required={true}>
  <Type>[UUID](https://www.npmjs.com/package/uuid)</Type>
  <Description>
    UUID that uniquely identifies the delivery confirmation. This ID should
    never change.
  </Description>
</Field>
...
<Field name="packages[].packaging.id" required={true}>
  ...
  <Description>
    A UUID that uniquely identifies the object. This is the UUID you used in the
    [Packaging Definition](./../packaging.mdx) file for this packaging type.
  </Description>
</Field>
