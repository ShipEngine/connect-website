...
<Field name="id" type="string" nullable={false}>
  <Description>
    The unique ID of the pickup to be cancelled. This string will not contain
    newline characters.
  </Description>
</Field>
...
<Field name="pickupService.id" nullable={false}>
  <Type>[UUID](https://www.npmjs.com/package/uuid)</Type>
  <Description>
    A UUID that uniquely identifies the pickup service. This ID should never
    change. This is the UUID you used in the [Pickup Service
    Definition](./../pickup-service.mdx) file for this pickup service.
  </Description>
</Field>
...
<Field name="reason" type="string" nullable={false}>
  <Description>
    ...
    `not_ready` - The package was not ready for pickup. * `price` - The customer
    cancelled the pickup because of the price. * `schedule` - The pickup was
    cancelled because it could not be picked up within the needed time sframe. *
    `carrier_failed_pickup` - The carrier failed to pick up the package. *
    `other` - The cancellation is for a reason not covered by any of the other
    categories.
  </Description>
</Field>
...
<Field name="notes" type="object[]" nullable={false}>
  <Description>
    An array of objects containing additional information about this
    cancellation.
  </Description>
</Field>
...
<Field name="timeWindows" type="object[]" nullable={false}>
  <Description>
    A list of dates and times when the carrier intended to pickup. This array
    will contain at least one value.
  </Description>
</Field>
...
<Field name="shipments" type="object[]" nullable={false}>
  <Description>
    A list of shipments that were scheduled to be picked up. This array will
...
<Field name="shipments[].deliveryService" nullable={false}>
  ...
  <Description>
    The delivery service assigned to the original pickup request. This array
    will contain at least one value.
  </Description>
</Field>
...
<Field name="shipments[].metadata" type="object" nullable={false}>
  <Description>
    The carrier's custom data about this shipment that was previously persisted
    by the ShipEngine Platform.
  </Description>
</Field>
...
<Field name="shipments[].packages[].packaging.id" nullable={false}>
  <Type>[UUID](https://www.npmjs.com/package/uuid)</Type>
  <Description>
    A UUID that uniquely identifies this packaging. This is the UUID you used
    int he [Packaging Definition](./../packaging.mdx) file for this packaging.
  </Description>
</Field>
...
>
  <Description>
    Optional code used to map to what the carrier uses to identify the
    packaging.
  </Description>
</Field>
...
<Field name="shipments[].packages[].metadata" type="object" nullable={true}>
  <Description>
    The carrier's custom data about this package that was previously persisted
    by ShipEngine Connect. Must be JSON serializable.
  </Description>
</Field>
...
<Field name="confirmationNumber" type="string" required={false}>
  <Description>
    The confirmation number for this cancellation request. This string must not
    contain newline characters.
  </Description>
</Field>
...
<Field name="description" type="string" required={false}>
  <Description>
    ...
    should not be specific to this particular pickup. This string must not
    contain newline characters.
  </Description>
</Field>
...
<Field name="metadata" type="object" required={false}>
  <Description>
    Custom data about this pickup that will be persisted by ShipEngine Connect.
