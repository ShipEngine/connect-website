...
```typescript
import { Transaction, SalesOrderTimeRange, SalesOrderArray } from "@shipengine/connect-sdk";
...
<Reference>
  ...
  <Field name="shipTo" required={true}>
    ...
    <Description>
      The buyer who bought the order. This is not necessarily the same person as the `shipTo`. Be sure to include the extra contact info fields as indicated in the reference doc.
    </Description>
  </Field>
  ...
  <Field name="adjustments" required={false}>
    ...
    <Description>
      The breakdown of adjustments for this sales order. <br/> <br/> These adjustments will appear as line items once this order is imported.
    </Description>
  </Field>

  <Field name="charges" type="object" required={false}>
    <Description>
      The breakdown of charges for this sales order.
    </Description>
  </Field>

  <Field name="charges.subTotal" type="object" required={false}>
    <Description>
      The subtotal for this sales order.
    </Description>
  </Field>

  <Field name="charges.subTotal.value" type="number" required={true}>
    <Description>
      The value for the subtotal.
    </Description>
  </Field>

  <Field name="charges.subTotal.currency" type="string" required={true}>
    <Description>
      The currency for the subtotal.
    </Description>
  </Field>

  <Field name="charges.taxAmount" type="object" required={false}>
    <Description>
      The tax amount for this sales order.
    </Description>
  </Field>

  <Field name="charges.taxAmount.value" type="number" required={true}>
    <Description>
      The value for the tax amount.
    </Description>
  </Field>

  <Field name="charges.taxAmount.currency" type="string" required={true}>
    <Description>
      The currency for the tax amount.
    </Description>
  </Field>

  <Field name="charges.shippingAmount" type="object" required={false}>
    <Description>
      The shipping amount for this sales order.
    </Description>
  </Field>

  <Field name="charges.shippingAmount.value" type="number" required={true}>
    <Description>
      The value for the shipping amount.
    </Description>
  </Field>

  <Field name="charges.shippingAmount.currency" type="string" required={true}>
    <Description>
      The currency for the shipping amount.
    </Description>
  </Field>

  <Field name="charges.shippingCost" type="object" required={false}>
    <Description>
      The shipping cost for this sales order.
    </Description>
  </Field>

  <Field name="charges.shippingCost.value" type="number" required={true}>
    <Description>
      The value of the shipping cost.
    </Description>
  </Field>

  <Field name="charges.shippingCost.currency" type="string" required={true}>
    <Description>
      The curency for the shipping cost.
    </Description>
  </Field>

  <Field name="charges.confirmationCost" type="object" required={false}>
    <Description>
      The confirmation cost for this sales order.
    </Description>
  </Field>

  <Field name="charges.confirmationCost.value" type="number" required={true}>
    <Description>
      The value for the confirmation cost.
    </Description>
  </Field>

  <Field name="charges.confirmationCost.currency" type="string" required={true}>
    <Description>
      The currency for the confirmation cost.
    </Description>
  </Field>

  <Field name="charges.insuranceCost" type="object" required={false}>
    <Description>
      The insurance cost for this sales order.
    </Description>
  </Field>

  <Field name="charges.insuranceCost.value" type="number" required={true}>
    <Description>
      The value for the insurance cost.
    </Description>
  </Field>

  <Field name="charges.insuranceCost.currency" type="string" required={true}>
    <Description>
      The currency for the insurance cost.
    </Description>
  </Field>

  <Field name="charges.otherCost" type="object" required={false}>
    <Description>
      Other costs associated with this sales order that do not fit into any of the other categories.
    </Description>
  </Field>

  <Field name="charges.otherCost.value" type="number" required={true}>
    <Description>
      The value of the cost.
    </Description>
  </Field>

  <Field name="charges.otherCost.currency" type="string" required={true}>
    <Description>
