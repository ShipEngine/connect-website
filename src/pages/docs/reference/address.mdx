...
<Field name="company" type="string" nullable={true} required={false}>
  <Description>
    The company name for the address, if provided. This string must not include
    newline characters.
  </Description>
</Field>
...
<Field name="addressLines" type="string[]" nullable={true} required={false}>
  <Description>
    Rather than providing two or three distinct address fields, simply provide
    all lines of the address in a string array. Each string in the array must be
    between `0` and `100` characters and must not include newline characters.
  </Description>
</Field>
...
<Field name="cityLocality" type="string" nullable={true} required={false}>
  <Description>
    The city or locality for this address. This string must not include newline
    characters.
  </Description>
</Field>
...
<Field name="stateProvince" type="string" nullable={true} required={false}>
  <Description>
    The state or province for this address. This string must not include newline
    characters.
  </Description>
</Field>
...
<Field name="postalCode" type="string" nullable={false} required={false}>
  <Description>
    The zip code or other postal code for this address. This string must not
...
<Field name="name.title" type="string" nullable={false} required={false}>
  <Description>
    The title of the contact (eg "Mr", "Mrs", "Dr"). This must not include
    newline characters.
  </Description>
</Field>
...
<Field name="name.family" type="string" nullable={false} required={false}>
  <Description>
    The last name or family name of the signer. This must not include newline
    characters.
  </Description>
</Field>
...
<Field name="name.suffix" type="string" nullable={false} required={false}>
  <Description>
    The suffix of the signer (eg "Sr", "Jr", "IV"). This must not include
    newline characters.
  </Description>
</Field>
...
<Field name="company" type="string" nullable={false} required={true}>
  <Description>
    The company name for the address, if provided. This string must not include
    newline characters and must not include newline characters.
  </Description>
</Field>
...
<Field name="phoneNumber" type="string" nullable={false} required={false}>
  <Description>
    The phone number of the contact. This string must not include newline
    characters.
  </Description>
</Field>
