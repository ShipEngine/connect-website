...
<Field name="ship_datetime" type="string" nullable={false}>
  <Description>
    ...
    Formatted per the https://tools.ietf.org/html/rfc3339 spec. Will always be
    in UTC.
  </Description>
</Field>
...
<Field name="confirmation" type="string" nullable={true}>
  ...
  <Description>
    The requested [confirmation](./../common-types.mdx) for this label. If the
    field is absent it should be interpreted as "None".
  </Description>
</Field>
...
<Field name="is_test_label" type="boolean" nullable={true}>
  <Description>
    Whether this request is the result of a test. When true the request must not
    result in any financial charges to any party. If the field is absent it
...
<Field name="advanced_options" type="object" nullable={true}>
  <Description>
    This is a schemaless object. It is for open ended customizations unique to
    particular carriers. If the field is absent it should be interpreted as the
    default value for any applicable options, e.g. false for booleans.
  </Description>
</Field>
...
<Field name="packages" nullable={false}>
  ...
  <Description>
    All the packages that make up this shipment. There will always be at least
    one package defined.
  </Description>
</Field>
...
<Field name="pickup_location" nullable={true}>
  ...
  <Description>
    If this is a pickup shipment, a pickup location will be populated for where
    the recipient can pickup the shipment.
  </Description>
</Field>
...
<Field name="ship_from_display" nullable={true}>
  ...
  <Description>
    The address that should be displayed as the return address, only if the
    carrier supports this functionality.
  </Description>
</Field>
...
<Field name="reference" type="string" nullable={true}>
  <Description>
    A user specified free form string to identify this shipment in their own
    system.
  </Description>
</Field>
...
<Field name="fulfillment_plan_details" nullable={true}>
  <Type>
    [fulfillment plan details
    object](./../fulfillment-plan-details.mdx#fulfillment-plan-details-object)
  </Type>
  <Description>
    Details regarding the fulfillment plan and/or original sales order, only if
    the carrier provider requires this info for label generation.
  </Description>
</Field>
...
<Field name="attachments" nullable={true}>
  ...
  <Description>
    Attachments that may be required to be sent to the carrier, in particular
    customs documents or commercial invoices.
  </Description>
</Field>
...
<Field name="form_download" type="object" required={false}>
  <Description>
    This provides any additional forms that go with the label. For example,
    customs forms.
  </Description>
</Field>
...
<Field name="tracking_number" type="string" required={false}>
  <Description>
    The carrier specific tracking identifier for this shipment; if a
    multi-package shipment, this should be the lead tracking number.
  </Description>
</Field>
