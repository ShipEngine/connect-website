...
<Field name="included_labels" nullable={true}>
  ...
  <Description>
    The shipments to include in the manifest. There should be at least one
    shipment included in a manifest.
  </Description>
</Field>
...
<Field name="open_datetime" type="string" nullable={true}>
  <Description>
    The date and time of the earliest shipment being manifested. Formatted per
...
<Field name="close_datetime" type="string" nullable={true}>
  <Description>
    The date and time of the last shipment being manifested. Formatted per the
...
<Field name="manifests" type="object[]" required={true}>
  <Description>
    The manifests created from this request. It should contain either a href or
    data, but not both.
  </Description>
</Field>
