...
One of the key benefits of integrating your service with [ShipEngine Connect](../../index.mdx) is that we will handle the 
hosting of your application for you. In order for us to do that, ShipEngine Connect may need access to sensitive data,
