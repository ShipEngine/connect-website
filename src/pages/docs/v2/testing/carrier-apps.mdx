...
> **INFO:** These tests exercise your [`Register` method](../reference/methods/register.mdx) and your
> connection form.
...
> **INFO:**
> These tests validate that your [definitions](./../structure.mdx#Definitions) were processed correctly
...
> **INFO:**
> These tests exercise your [`GetRates` method](../reference/methods/get-rates).
...
> **INFO:** These tests exercise your [`CreateLabel` method](../reference/methods/create-label.mdx).
...
> **INFO:** These tests execute your [`GetRates` method](../reference/methods/get-rates.mdx).
...
> **INFO:** These tests exercise your [`GetRates` method](../reference/methods/get-rates.mdx).
...
> **INFO:** These tests exercise your [`VoidLabels` method](../reference/methods/void-labels.mdx).
...
> **INFO:** These tests exercise your [`Track` method](../reference/methods/track.mdx).
...
This test validates the `TrackingUrl` property in your [Carrier App definition](../app-definition/carrier.mdx).
...
> **INFO:** These tests exercise your [`CancelPickup` method](../reference/methods/cancel-pickup.mdx).
