---
title: Changelog
description: This page describes the changes that occurred pre CLI `v1.0.22` and SDK `v1.0.16`.
image: /img/changelog/card.png
---

# Changelog Pre `v1.0.22`

> Previous to CLI `v1.0.22` and SDK `v1.0.16` there were so many changes in flux that we were unable to maintain a meticulous changelog. Those changes for the most part have settled and moving forward the changelog will be the place of "truth" as to what has changed in the connect SDK and connect CLI.
