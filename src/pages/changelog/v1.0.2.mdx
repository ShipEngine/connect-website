...
- Updated [CLI](../docs/v1/cli.mdx) namespace. You should uninstall the old one before the latest version.
- Removed [NotesType](../docs/v1/reference/common-types.mdx#notes-types) not supported by ShipStation.
- Removed `POJO`
...
- [CLI](../docs/v1/cli.mdx) commands are no longer prefaced with `apps:`. The documentation has been updated.
- The `shipengine test` command has changed. We are in the process of updating the documentation for this.

## Carrier App

These changes affect the [Carrier App](../docs/v1/carrier-app/index.mdx).

### [Carrier App Definition](../docs/v1/reference/carrier.mdx)
...
### [schedulePickup()](../docs/v1/reference/methods/schedule-pickup.mdx)
...
### [cancelPickup()](../docs/v1/reference/methods/cancel-pickups.mdx)
...
[Delivery Service](../docs/v1/reference/delivery-service.mdx)
_ Added `supportsReturns` property.
_ Added `manifestType` property. \* Added `code` property.

[Pickup Service](../docs/v1/reference/pickup-service.mdx)

- Added `code` property.

[Packaging](../docs/v1/reference/packaging.mdx)

- Added `code` property.

[Delivery Confirmation](../docs/v1/reference/delivery-confirmation.mdx)

- Added `code` property.

## Order App

These changes affect the [Order App](../docs/v1/order-app/index.mdx).

### Overall Changes

- Removed `deliveryDateTime` from [Shipping Preferences](../docs/v1/reference/shipping-preferences.mdx)

### [Order App Definition](../docs/v1/reference/order.mdx)

- Added an icon property similar to the logo property.
- Added a `sendEmail` property
- Added a `configureTimeZone` property

### [getSalesOrdersByDate()](../docs/v1/reference/methods/get-sales-orders-by-date.mdx)
...
### [shipmentCreated()](../docs/v1/reference/methods/shipment-created.mdx)
...
### [shipmentCancelled()](../docs/v1/reference/methods/shipment-cancelled.mdx)
