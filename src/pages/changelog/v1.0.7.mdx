...
- Added additional meta data to the `connect publisch` command. It now include the current version of `node`, `connect-cli`, `connect-sdk`, `connect-local-dev-api`, and `connect-local-dev-ui` when creating a new deployment.
