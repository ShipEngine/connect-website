...
export function buildAddressWithContactInfo(
  ...
  const countryMap: Record<string, AddressWithContactInfoPOJO> = {
    'US-from': Object.assign(
      buildAddress('US-from'),
      buildContactInfo('US-from'),
    ),
    'US-to': Object.assign(buildAddress('US-to'), buildContactInfo('US-to')),
    'CA-from': Object.assign(
      buildAddress('CA-from'),
      buildContactInfo('CA-from'),
    ),
    'CA-to': Object.assign(buildAddress('CA-to'), buildContactInfo('CA-to')),
    'MX-from': Object.assign(
      buildAddress('MX-from'),
      buildContactInfo('MX-from'),
    ),
    'MX-to': Object.assign(buildAddress('MX-to'), buildContactInfo('MX-to')),
    'GB-from': Object.assign(
      buildAddress('GB-from'),
      buildContactInfo('GB-from'),
    ),
    'GB-to': Object.assign(buildAddress('GB-to'), buildContactInfo('GB-to')),
    'PT-from': Object.assign(
      buildAddress('PT-from'),
      buildContactInfo('PT-from'),
    ),
    'PT-to': Object.assign(buildAddress('PT-to'), buildContactInfo('PT-to')),
    'ES-from': Object.assign(
      buildAddress('ES-from'),
      buildContactInfo('ES-from'),
    ),
    'ES-to': Object.assign(buildAddress('ES-to'), buildContactInfo('ES-to')),
    'FR-from': Object.assign(
      buildAddress('FR-from'),
      buildContactInfo('FR-from'),
    ),
    'FR-to': Object.assign(buildAddress('FR-to'), buildContactInfo('FR-to')),
    'NL-from': Object.assign(
      buildAddress('NL-from'),
      buildContactInfo('NL-from'),
    ),
    'NL-to': Object.assign(buildAddress('NL-to'), buildContactInfo('NL-to')),
    'BE-from': Object.assign(
      buildAddress('BE-from'),
      buildContactInfo('BE-from'),
    ),
    'BE-to': Object.assign(buildAddress('BE-to'), buildContactInfo('BE-to')),
    'DE-from': Object.assign(
      buildAddress('DE-from'),
      buildContactInfo('DE-from'),
    ),
    'DE-to': Object.assign(buildAddress('DE-to'), buildContactInfo('DE-to')),
    'IT-from': Object.assign(
      buildAddress('IT-from'),
      buildContactInfo('IT-from'),
    ),
    'IT-to': Object.assign(buildAddress('IT-to'), buildContactInfo('IT-to')),
    'DK-from': Object.assign(
      buildAddress('DK-from'),
      buildContactInfo('DK-from'),
    ),
    'DK-to': Object.assign(buildAddress('DK-to'), buildContactInfo('DK-to')),
    'CH-from': Object.assign(
      buildAddress('CH-from'),
      buildContactInfo('CH-from'),
    ),
    'CH-to': Object.assign(buildAddress('CH-to'), buildContactInfo('CH-to')),
    'AT-from': Object.assign(
      buildAddress('AT-from'),
      buildContactInfo('AT-from'),
    ),
    'AT-to': Object.assign(buildAddress('AT-to'), buildContactInfo('AT-to')),
    'NO-from': Object.assign(
      buildAddress('NO-from'),
      buildContactInfo('NO-from'),
    ),
    'NO-to': Object.assign(buildAddress('NO-to'), buildContactInfo('NO-to')),
    'SE-from': Object.assign(
      buildAddress('SE-from'),
      buildContactInfo('SE-from'),
    ),
    'SE-to': Object.assign(buildAddress('SE-to'), buildContactInfo('SE-to')),
    'FI-from': Object.assign(
      buildAddress('FI-from'),
      buildContactInfo('FI-from'),
    ),
    'FI-to': Object.assign(buildAddress('FI-to'), buildContactInfo('FI-to')),
    'PL-from': Object.assign(
      buildAddress('PL-from'),
      buildContactInfo('PL-from'),
    ),
    'PL-to': Object.assign(buildAddress('PL-to'), buildContactInfo('PL-to')),
    'CZ-from': Object.assign(
      buildAddress('CZ-from'),
      buildContactInfo('CZ-from'),
    ),
    'CZ-to': Object.assign(buildAddress('CZ-to'), buildContactInfo('CZ-to')),
    'LU-from': Object.assign(
      buildAddress('LU-from'),
      buildContactInfo('LU-from'),
    ),
    'LU-to': Object.assign(buildAddress('LU-to'), buildContactInfo('LU-to')),
    'AU-from': Object.assign(
      buildAddress('AU-from'),
      buildContactInfo('AU-from'),
    ),
    'AU-to': Object.assign(buildAddress('AU-to'), buildContactInfo('AU-to')),
    'NZ-from': Object.assign(
      buildAddress('NZ-from'),
      buildContactInfo('NZ-from'),
    ),
    'NZ-to': Object.assign(buildAddress('NZ-to'), buildContactInfo('NZ-to')),
    'BR-from': Object.assign(
      buildAddress('BR-from'),
      buildContactInfo('BR-from'),
    ),
