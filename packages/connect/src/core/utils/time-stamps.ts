...
export function initializeTimeStamps(): TimeStamps {
  ...
  const yesterday = DateTime.local(
    ...
    .minus({ days: 1 })
    .toISO();
  const todayEarly = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
  ...
  const today = DateTime.local(
    ...
    .plus({ hours: 12 })
    .toISO();
  const todayEvening = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
    .plus({ hours: 18 })
    .toISO();
  const tomorrowEarlyAM = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
    .plus({ days: 1, hours: 6 })
    .toISO();
  const tomorrowEarly = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
  ...
  const tomorrow = DateTime.local(
    ...
    .toISO();
  const tomorrowEvening = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
  ...
  const twoDays = DateTime.local(
    ...
    .toISO();
  const twoDaysEarly = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
    .plus({ days: 2, hours: 9 })
    .toISO();
  const threeDays = DateTime.local(
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
  )
