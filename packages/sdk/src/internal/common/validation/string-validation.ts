...
export const stringValidation: joi.Extension = {
  ...
  messages: {
    ...
    'string.isoDateTime':
      '{{#label}} must be an ISO 8601 date and time, like 2005-09-23T17:30:00',
    'string.isoDateTimeZone':
      '{{#label}} must be a complete ISO 8601 date/time with a time zone, like 2005-09-23T17:30:00+05:30',
    'string.isoDateTimeNoZone': '{{#label}} should not include a time zone',
    'string.isoDateTimeInvalid': '{{#label}} must be a valid date/time',
    'string.timeZone':
      '{{#label}} must be a UTC offset, like "+05:30", or a valid IANA time zone, like "America/Los_Angeles"',
    'string.appName':
      '{{#label}} must be a scoped NPM package name, like "@company-name/app-name"',
    ...
    'string.websiteIncomplete':
      '{{#label}} must be a complete website URL, including "http://" or "https://"',
    'string.locale':
      '{{#label}} must be a valid language code, like "en" or "en-US"',
