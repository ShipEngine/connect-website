...
import {
  RequestedFulfillmentExtensions as IRequestedFulfillmentExtensions,
  RequestedFulfillmentPOJO,
...
export class RequestedFulfillment {
  public static readonly [_internal] = {
    ...
    schema: Joi.object({
      items: Joi.array()
        .min(1)
        .items(SalesOrderItem[_internal].schema.optional())
        .required(),
