...
const expectedCredentials = [
	...
	[
		...
		{ ...defaultCredentials, username: 'test' },
	],
	[
		{ userId: '', password: 'test' },
		{ ...defaultCredentials, password: 'test' },
	],
	[
...
describe('Register Response', () => {
	...
	describe('when we have a fully formed transaction with basicAuth attached', () => {
		...
		it('maps the session correctly', () =>
			expect(response.metadata).toEqual(session));
		it('maps the credentials correctly', () =>
	...
	describe('Get Credentials', () => {
		test.each(expectedCredentials)(
			'getCredentials(%o) maps to %o',
