...
<Reference>
  ...
  <Field name="availableCountries" type="string[]" required={true}>
    <Description>
      The sellers home [countries](./country-codes.mdx) in [ISO 3166-1 alpha-2 format](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes) that should have access to this service.
    </Description>
  </Field>
