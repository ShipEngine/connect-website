...
describe("validateConfig", () => {
  ...
  describe("tests.cancelShipments_single when given an object", () => {
    it("validates that retries is a number", () => {
      const config = {
        tests: {
          cancelShipments_single: {
            retries: "invalid"
          }
        },
      };
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.retries must be a number");
    });
    ...
    it("validates that timeout is a number", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.timeout must be a number");
    });
    ...
    it("validates that skip is a boolean", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.skip must be a boolean");
    });
    ...
    it("validates that session is an object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.session must be of type object");
    });
    ...
    it("validates that connectArgs is an object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.connectArgs must be of type object");
    });
    ...
    it("validates that deliveryServiceName is a string", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.deliveryServiceName must be a string");
    });
    ...
    it("validates that shipFrom is an address object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.shipFrom must be of type object");
    });
    ...
    it("validates that shipTo is an address object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.shipTo must be of type object");
    });
    ...
    it("validates that weight is a weight object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.weight must be of type object");
    });
    ...
    it("validates that shipDateTime is a valid date time string", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single.shipDateTime must be a complete ISO 8601 date/time with a time zone, like 2005-09-23T17:30:00+05:30");
    });
  });

  describe("tests.cancelShipments_single when given an array", () => {
    it("validates that retries is a number", () => {
      const config = {
        tests: {
          cancelShipments_single: [{
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].retries must be a number");
    });
    ...
    it("validates that timeout is a number", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].timeout must be a number");
    });
    ...
    it("validates that skip is a boolean", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].skip must be a boolean");
    });
    ...
    it("validates that session is an object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].session must be of type object");
    });
    ...
    it("validates that connectArgs is an object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].connectArgs must be of type object");
    });
    ...
    it("validates that deliveryServiceName is a string", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].deliveryServiceName must be a string");
    });
    ...
    it("validates that shipFrom is an address object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].shipFrom must be of type object");
    });
    ...
    it("validates that shipTo is an address object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].shipTo must be of type object");
    });
    ...
    it("validates that weight is a weight object", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].weight must be of type object");
    });
    ...
    it("validates that shipDateTime is a valid date time string", () => {
      ...
      expect(result).to.be.undefined;
      expect(errorResult.message).to.be.equal("tests.cancelShipments_single[0].shipDateTime must be a complete ISO 8601 date/time with a time zone, like 2005-09-23T17:30:00+05:30");
    });
  });
