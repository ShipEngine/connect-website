---
title: Testing Guide
description: This guide describes how to test an Order app within ShipStation.
---

# Testing Guide

The purpose of an Order App is to integrate your store or marketplace
...
[ShipStation](http://www.shipstation.com). Your order app running in the platform makes it possible for ShipStation to
