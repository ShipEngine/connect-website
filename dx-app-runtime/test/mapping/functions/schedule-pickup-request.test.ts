...
describe('Schedule Pickup Request', () => {
    it('when a pickup service is defined it maps correctly', () => expect(mapSchedulePickupRequest({ ...minimalRequest, pickup_details: { pickup_service_code: 'service code' } }).pickupService).toEqual('service code'));
    it('when a pickup service is not defined it maps to an empty string', () => expect(mapSchedulePickupRequest({ ...minimalRequest, pickup_details: { pickup_service_code: undefined } }).pickupService).toEqual(''));
    it('when a there are no pickup_details pickupService maps to an empty string', () => expect(mapSchedulePickupRequest({ ...minimalRequest }).pickupService).toEqual(''));
    it('when we have a fully formed schedule pickup request it maps correctly', () => expect(mapSchedulePickupRequest(fullSchedulePickupRequest)).toEqual(fullSchedulePickupExpectedMapping));
});