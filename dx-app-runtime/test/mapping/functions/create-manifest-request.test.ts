...
import { mapManifestShipments, mapCreateManifestRequest } from '../../../src/mapping/functions';
...
describe('Create Manifest Request', () => {
    describe('Mapping Manifest Shipments', () => {
        ...
        it('when given a label it maps trackingNumber correctly', () => expect(result.trackingNumber).toEqual('trackingNumber'));
        it('when given a label it maps carrierTransactionId correctly', () => expect(result.identifiers?.carrierTransactionId).toEqual('carrierTransactionId'));
    });
    describe('Mapping a Manifest Request', () => {
        describe('when mapping a full create manifest request', () => {
            ...
            it('it maps openDateTime correclty', () => expect(result.openDateTime).toEqual('2019-12-06T01:27:34Z'));
            it('it maps closeDateTime correctly', () => expect(result.closeDateTime).toEqual('2019-12-06T01:27:34Z'));
        });
        describe('when mapping a minimal create manifest request without an open date provided', () => {
            ...
            it('it maps openDateTime to a default datetime of January 1st 2000', () => expect(result.openDateTime).toEqual('2000-01-01T01:00:00Z'));
        });
    });
});