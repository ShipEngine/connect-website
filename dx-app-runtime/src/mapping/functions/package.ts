...
export const capiToDxPackage = (capiPackage: Package, customs: Customs | null | undefined, advancedOptions: AdvancedShippingOptions | null | undefined): NewPackagePOJO | RatePackagePOJO => {
...
export const capiToDxNewPackagePOJO = (capiPackage: Package, customs: Customs | null | undefined, advancedOptions: AdvancedShippingOptions | null | undefined): NewPackagePOJO => {
  const nonNullCustomsItems = (<CapiCustomsItem[] | undefined>customs?.customs_items.filter(item => (item !== null && item !== undefined)));
  const mappedPackage = {
    customs: {
      contents: nonNullCustomsItems?.map((item: CapiCustomsItem) => {
...
export const capiToDxPackageRateCriteria = (capiPackage: Package, customs: Customs | null | undefined, advancedOptions: AdvancedShippingOptions | null | undefined) : PackageRateCriteriaPOJO => {
  const nonNullCustomsItems = (<CapiCustomsItem[] | undefined>customs?.customs_items.filter(item => (item !== null && item !== undefined)));
