...
export const getReturnToAddress = (isReturn?: boolean, from?: Address | null, display?: Address | null): AddressWithContactInfoPOJO | undefined => {
...
export const mapCreateLabelRequest = (
  ...
  return {
    ...
    returnTo: getReturnToAddress(request.is_return_label, request.ship_from, request.ship_from_display),
